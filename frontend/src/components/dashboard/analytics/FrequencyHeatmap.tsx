      ...
      <div className="relative flex flex-wrap items-center justify-between gap-2">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <div className="min-w-0">
            <p className="truncate text-sm font-semibold text-ink-900">Workout Frequency</p>
            <p className="truncate text-xs text-ink-500">Last {weeks.length} weeks</p>
          </div>
        </div>
        <p className="shrink-0 text-xs font-medium text-ink-600">{activeDays} active days</p>
      </div>
