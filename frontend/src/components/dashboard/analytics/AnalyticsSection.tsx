      ...
      <div className="card p-5">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-ink-500">Trends across your finished workouts</p>
          </div>
        </div>
        <div className="mt-4">
          <EmptyState
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 px-1">
        ...
        <p className="text-xs font-semibold uppercase tracking-wider text-ink-400">Analytics</p>
      </div>
